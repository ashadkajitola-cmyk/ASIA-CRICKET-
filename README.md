...
<script>
    ...
    function checkAdminAccess() {
        ...
        if(!hasActiveSub) {
            alert("Galat ya expired subscription! Bina active subscription ke admin panel open nahi ho sakta.");
            return;
        }
    ...
    // 1. REDEEM CODE GENERATE (Admin Only)
    function generateRedeemCode() {
        ...
        alert(`Redeem code '${code}' (${points} Points) successfully ban gaya hai! Ab koi bhi user iska use kar sakta hai.`);
    }
    ...
    function redeemCodeAction() {
        ...
        // Code delete kar diya jayega taaki dobara use na ho sake
